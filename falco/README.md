...
| `falcosidekick.disableHttpOutput`          | Disable Falco's HTTP output to send alerts to  `falcosidekick` when `falcosidekick.enabled` is `true` to allow for another output to be enabled.                                                                                                                                                                          | `false`                                                                                                                 |

...
The following table lists the main configurable parameters of the k8s-metacollector chart v0.3.2 and their default values. See `values.yaml` for full list.

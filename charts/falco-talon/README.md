...
The available values in `values.yaml` are:
...
```shell
helm upgrade -i falco falco-talon/falco \
  --namespace falco \
  --create-namespace \
  --set tty=true \

...
| grafana.dashboards.configMaps.talon | object | `{"folder":"","folderAnnotation":"grafana_dashboard_folder","name":"falco-talon-grafana-dashboard","namespace":""}` | falco-talon contains the configuration for falco talon's dashboard. |
| grafana.dashboards.configMaps.talon.folder | string | `""` | folder where the dashboard is stored by grafana. |
| grafana.dashboards.configMaps.talon.folderAnnotation | string | `"grafana_dashboard_folder"` | annotation used by grafana |

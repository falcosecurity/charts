...
The following table lists the main configurable parameters of the falco chart v4.2.6 and their default values. See [values.yaml](./values.yaml) for full list.

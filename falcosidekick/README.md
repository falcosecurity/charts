...
| config.templatedfields | string | `""` | a list of comma separated templated fields to add to falco events and metrics, it uses Go template + output_fields values. The syntax is "key:value,key:value". |
